...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1870623341;
...
abstract class RustLibApi extends BaseApi {
  ...
  Float32List crateApiRenderingGetEffectiveHeightRange();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Float32List crateApiRenderingGetEffectiveHeightRange() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiRenderingGetEffectiveHeightRangeConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiRenderingGetEffectiveHeightRangeConstMeta => const TaskConstMeta(
        debugName: "get_effective_height_range",
        argNames: [],
      );
  ...
  Future<String> crateApiSystemTestAsync() {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 261, port: port_);
      },
      codec: SseCodec(
        decodeSuccessData: sse_decode_String,
        decodeErrorData: null,
  ...
  Future<String> crateApiRenderingTestRendererInit() {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 263, port: port_);
      },
      codec: SseCodec(
        decodeSuccessData: sse_decode_String,
        decodeErrorData: sse_decode_String,
  ...
  Future<void> crateApiOverlayUploadDrawingOverlay(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 270, port: port_);
      },
      codec: SseCodec(
        decodeSuccessData: sse_decode_unit,
        decodeErrorData: sse_decode_String,
