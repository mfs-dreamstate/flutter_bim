        ...
        content: Column(
          ...
          children: [
            ...
            _SampleOption(
              ...
              onTap: () => Navigator.pop(context, 'assets/test/sample_structural.ifc'),
            ),
            _SampleOption(
              icon: Icons.plumbing,
              color: Colors.teal,
              ...
              onTap: () => Navigator.pop(context, 'assets/test/sample_mep.ifc'),
            ),
            _SampleOption(
              ...
              onTap: () => Navigator.pop(context, 'assets/test/sample_electrical.ifc'),
            ),
            const Divider(),
            _SampleOption(
              ...
              onTap: () => Navigator.pop(context, 'assets/test/sample_building.ifc'),
            ),
          ],
        ),
        actions: [
